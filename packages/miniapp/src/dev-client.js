  ...
  function showDisconnected() {
    ...
    function showMessage() {
      ...
      notice.style.cssText =
        'position:fixed;inset:0;z-index:2147483647;display:flex;align-items:center;justify-content:center;padding:24px;box-sizing:border-box;background:radial-gradient(ellipse at top,#eef2ff,#f8fafc 65%);color:#475569;font:14px/1.7 system-ui,sans-serif;text-align:center'
      var card = document.createElement('div')
      card.style.cssText =
        'max-width:360px;padding:24px 28px;border:1px solid #e2e8f0;border-radius:16px;background:#fff;box-shadow:0 8px 32px #0f172a08'
