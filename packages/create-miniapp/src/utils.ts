...
export function resolveTemplateId(framework: Framework, variant: Variant): string {
...
export function supportsBiomeLinter(framework: Framework): boolean {
  return framework === 'vanilla' || framework === 'react' || framework === 'vue'
}
...
export function normalizeFeatures(features: Feature[] | undefined, framework: Framework): Feature[] {
  let result: Feature[] = []
